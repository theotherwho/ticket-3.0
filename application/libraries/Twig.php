...
class Twig
{
	...
	private $functions_safe = [
		'form_open', 'form_close', 'form_error', 'set_value', 'form_hidden', 'link_tag'
	];
	...
	protected function addCIFunctions()
	{
		...
		foreach ($this->functions_safe as $function)
		{
			if (function_exists($function))
			{
				$this->twig->addFunction($function, new Twig_Function_Function($function,['is_safe' => ['html']]));
			}
		}
		...
		{
			$this->twig->addFunction('anchor', new Twig_Function_Function([$this, 'safe_anchor'],['is_safe' => ['html']]));
		}
